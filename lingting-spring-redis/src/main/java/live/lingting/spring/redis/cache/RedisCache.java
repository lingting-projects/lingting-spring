...
public class RedisCache {
	...
	public <T> T set(String key, ThrowingSupplier<T> onGet, ThrowingSupplier<T> onLockFailure) {
	...
	public <T> T setIfAbsent(String key, ThrowingSupplier<T> onGet, ThrowingSupplier<T> onLockFailure,
			Class<T> tClass) {
