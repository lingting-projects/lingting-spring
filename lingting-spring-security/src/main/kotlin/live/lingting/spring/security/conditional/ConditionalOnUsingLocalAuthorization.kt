...
@ConditionalOnProperty(prefix = SecuritySpringProperties.PREFIX + ".authorization", value = ["remote"], havingValue = "false", matchIfMissing = true)
annotation class ConditionalOnUsingLocalAuthorization
